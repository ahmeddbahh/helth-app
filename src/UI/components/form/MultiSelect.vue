            ...
            <div ref="overlay" class="p-multiselect-panel p-component" v-if="overlayVisible">
                <div class="p-multiselect-header" v-if="(showToggleAll && selectionLimit == null) || filter">
                    <div class="select-all-checkbox">
                        ...
                        <div class="select-all-label" v-if="headerLabel && showToggleAll && selectionLimit == null" @click="onToggleAll"><span>{{headerLabel}}</span></div>
                    </div>
...
<script>
import ConnectedOverlayScrollHandler from 'primevue/utils/ConnectedOverlayScrollHandler';
