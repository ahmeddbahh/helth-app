  ...
  <div class="login">
        <div class="form-wrapper" :class="{'arabic-content':local=='ar'}">
            ...
            <div class="create-btn d-flex justify-content-between">
                ...
                <div><Button :label="lang[local].siginBtn" :disabled="$v.$invalid" @click="login" class="p-button-rounded primary-btn-gradient" /></div>
            </div>
            ...
            <div class="mt-4"><h5><router-link to="/business">{{lang[local].business.link}}</router-link> {{lang[local].business.txt}}</h5></div>
...
<script>
import loginLang from '../../../mixins/authentication/loginLang.js';
