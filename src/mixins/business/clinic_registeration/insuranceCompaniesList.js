  ...
  data() {
    return {
      insuranceCompaniesList: [
        { english: "Medright", arabic: "ميد رايت" },
        { english: "Axa", arabic: "أكسا" },
        { english: "Metlife Alico", arabic: "ميتلايف اليكو" },
        { english: "Engineers Syndicate", arabic: "نقابة المهندسين" },
        { english: "Egycare", arabic: "ايجيكير" },
        { english: "Unicare", arabic: "يونى كير" },
        { english: "Prime Health", arabic: "برايم هيلث" },
        { english: "Egyptian Medical Syndicate", arabic: "نقابة الاطباء" },
        {
          english: "Diamond Medical Service",
          arabic: "دايموند ميديكال سيرفيس",
        },
        { english: "Abu Qir Fertilizers", arabic: "ابو قير للاسمدة" },
        {
          english: "Academy of Haram Talents ِand their Families",
          arabic: "اكاديمية موهوبين الهرم وذويهم",
        },
        { english: "Access", arabic: "اكسس" },
        { english: "Active Company", arabic: "شركة اكتف" },
        {
          english: "Active for Medical Services",
          arabic: "اكتف للخدمات الصحية",
        },
        { english: "Agiba Petroleum Company", arabic: "شركة بترول اجيبا" },
        {
        ...
        { english: "Agricultural Syndicate", arabic: "نقابة الزراعيين" },
        { english: "Agzakhana", arabic: "الاجزاخانة" },
        {
          english: "Ahly Medical Company (AMC)",
          arabic: "الاهلي للخدمات الطبية",
        },
        { english: "Air Cairo", arabic: "شركة اير كايرو" },
        { english: "Al Baraka Bank - Egypt", arabic: "بنك البركة - مصر" },
        {
        ...
        { english: "Al Mashreq", arabic: "المشرق" },
        { english: "Alashanwladna", arabic: "ألاشانولادنا" },
        {
          english: "Alexandria Water Company",
          arabic: "شركة المياه بالاسكندرية",
        },
        { english: "Alfa Care", arabic: "ألفا كير" },
        { english: "Allianz", arabic: "اليانز" },
        { english: "Allied Doctors", arabic: "الأطباء المتحدون" },
        { english: "Amal Petroleum Company", arabic: "شركة الأمل للبترول" },
        { english: "AMIS", arabic: "أميس" },
        { english: "Amoun Pharmaceuticals", arabic: "امون للادوية" },
        { english: "Amreya Petroleum", arabic: "الاميرية للبترول" },
        {
          english: "Arab African international bank",
          arabic: "البنك العربي الافريقي",
        },
        { english: "Arab Contractors Co.", arabic: "شركة المقاولون العرب" },
        { english: "Arab International Bank", arabic: "المصرف العربي الدولي" },
        {
        ...
        { english: "Badr Petroleum Company", arabic: "بدر للبترول" },
        { english: "Bahya Hospital", arabic: "مستشفى بهية" },
        { english: "Bank of Egypt Iran", arabic: "بنك مصر ايران" },
        { english: "Banque du Caire", arabic: "بنك القاهرة" },
        { english: "Banque Misr", arabic: "بنك مصر" },
        { english: "Belayim Petroleum Company", arabic: "بترول بلاعيم" },
        { english: "Beni Suef University", arabic: "جامعة بني سويف" },
        {
          english: "Bright Medical Technology Care",
          arabic: "برايت ميديكال تكنو كير",
        },
        { english: "Bupa Egypt Insurance", arabic: "شركة بوبا للتأمين" },
        { english: "Burj Al Arab Petroleum", arabic: "برج العرب للبترول" },
        { english: "Butagasco Company", arabic: "بوتجاسكو" },
        {
          english: "Cairo Pyramids Hotel",
          arabic: "فندق كايرو بيراميدز (موفنبيك سابقا)",
        },
        { english: "Care and Cure", arabic: "كير اند كيور" },
        { english: "CarePlus", arabic: "كير بلاس" },
        { english: "Cargas", arabic: "كارجاس" },
        {
          english: "Central Auditing Organization",
          arabic: "الجهاز المركزي للمحاسبات",
        },
        { english: "Central Bank of Egypt", arabic: "البنك المركزي المصري" },
        {
          english:
        ...
        { english: "City Care", arabic: "سيتى كير" },
        { english: "Click Mare Health Care", arabic: "كليك مير هيلث كير" },
        { english: "Commerce Syndicate", arabic: "نقابة التجاريين" },
        { english: "Conex Company", arabic: "شركة كونكس" },
        { english: "Co-operation for petrol", arabic: "التعاون للبترول" },
        {
          english:
        ...
        { english: "Dar Petroleum", arabic: "دار للبترول" },
        {
        ...
        { english: "East Gas Company", arabic: "شركة غاز الشرق" },
        {
          english: "East Zeit Petroleum 'ZEITCO'",
          arabic: "ايست زيت بتروليوم",
        },
        { english: "Eastern Tobacco Company", arabic: "الشركة الشرقية للدخان" },
        { english: "Easy Care", arabic: "ايزى كير" },
        { english: "Educational Syndicate", arabic: "نقابة المعلمين" },
        { english: "Egymed", arabic: "ايجيميد" },
        { english: "Egypt Gas", arabic: "غاز مصر" },
        { english: "Egypt Gym", arabic: "جيم مصر" },
        { english: "Egypt Phosphate", arabic: "فوسفات مصر" },
        { english: "Egyptian Ambulance Organization", arabic: "الاسعاف" },
        {
        ...
        {
          english: "Egyptian Nursery Syndicate\tنقابة الحضانات المصرية",
          arabic: "",
        },
        { english: "Egyptian Parliament", arabic: "البرلمان  المصري" },
        {
          english: "Egyptian Petroleum Carriers\tالمصرية لناقلات البترول",
          arabic: "",
        },
        {
        ...
        { english: "El Ahram Establishment", arabic: "مؤسسة الاهرام" },
        { english: "El Gamarek", arabic: "الجمارك" },
        {
        ...
        { english: "Elahly medical", arabic: "الاهلى الطبية" },
        { english: "EL-Mashreq for Investment", arabic: "المشرق للاستثمار" },
        { english: "Elmothida", arabic: "الموثدة" },
        {
        ...
        {
          english:
            "Enppi - Engineering Co. For The Petroleum and Process Industries",
        ...
        { english: "Extra Care", arabic: "رعاية اضافية" },
        { english: "Ezz steel", arabic: "حديد عز" },
        {
          english: "Faisal Islamic Bank of Egypt",
          arabic: "بنك فيصل الاسلامي المصري",
        },
        { english: "Family Care Cure", arabic: "علاج رعاية الأسرة" },
        { english: "Filmmakers Syndicate", arabic: "نقابة المخرجين" },
        {
        ...
        { english: "General Intelligence", arabic: "المخابرات العامة" },
        {
          english: "General Organization for Export and Import Control",
          arabic: "الهيئة العامة للرقابة على الصادرات والواردات",
        },
        { english: "General Petroleum Company", arabic: "شركة البترول العامة" },
        {
        ...
        { english: "Giza Trade Syndiacte", arabic: "نقابة تجارة الجيزة" },
        { english: "Globemed", arabic: "غلوب ميد" },
        { english: "Gupco", arabic: "جوبكو" },
        { english: "Hadayek Al Ahram Club", arabic: "نادي حدائق الاهرام" },
        {
          english: "Hala Trading, Marketing and Medical Services",
          arabic: "هلا للتجارة والتسويق والخدمات الطبية",
        },
        { english: "Hazem Hassan", arabic: "حازم حسن" },
        { english: "Health and Wealth", arabic: "الصحة و الغنى" },
        { english: "Health And Wealth Company", arabic: "شركة الصحة والثروة" },
        { english: "Health care", arabic: "الرعاىة الصحية" },
        { english: "Health Care Fund", arabic: "صندوق الرعاية الصحية" },
        {
          english: "Health care to the Ministry of Justice",
          arabic: "الرعاية الصحية لوزارة العدل",
        },
        { english: "Healthy Club", arabic: "كلوب صحي" },
        {
          english: "Housing and Building National Research Center",
          arabic: "المركز القومي لبحوث الإسكان والبناء",
        },
        { english: "INAYA Egypt", arabic: "عناية مصر" },
        { english: "Incoles Company", arabic: "شركة Incoles" },
        {
          english: "Information Technology Industry Development Agency",
          arabic: "هيئة تنمية صناعة تكنولوجيا المعلومات",
        },
        { english: "Interhealth", arabic: "انترهيلث" },
        { english: "ITIDA", arabic: "ايتيدا" },
        { english: "Journalists Syndicate", arabic: "نقابة الصحفيين" },
        { english: "Khalda Petroleum Company", arabic: "شركة خلدا للبترول" },
        { english: "Khedmty", arabic: "خدمتي" },
        { english: "Kuwait Embassy", arabic: "سفارة الكويت" },
        { english: "Lawyers Syndicate", arabic: "نقابة المحامين" },
        { english: "Life", arabic: "حياة" },
        { english: "Life Healthcare", arabic: "لايف للرعاية الصحية" },
        { english: "Life style", arabic: "أسلوب الحياة" },
        { english: "Magd Health Care", arabic: "مجد للرعاية الصحية" },
        { english: "Majesty Discount Cards", arabic: "بطاقات خصم ماجيستي" },
        { english: "Mansour Chevrolet", arabic: "منصور شيفروليه" },
        { english: "Mansoura University", arabic: "جامعة المنصورة" },
        {
          english: "Marasem International For Urban Development",
          arabic: "مراسم الدولية للتنمية العمرانية",
        },
        { english: "Marina Petroleum Company", arabic: "شركة مارينا للبترول" },
        { english: "Med Alfa", arabic: "ميد الفا" },
        { english: "MedCom", arabic: "ميدكوم" },
        { english: "MEDCOM Health care", arabic: "ميدكوم للرعاية الصحية" },
        { english: "MedGulf Co.", arabic: "شركة ميدغلف" },
        { english: "Medi gold", arabic: "ميدي جولد" },
        { english: "Media Syndicate", arabic: "نقابة الإعلاميين" },
        { english: "Medical Card", arabic: "بطاقة طبية" },
        {
          english:
        ...
        { english: "Medicare", arabic: "ميديكير" },
        { english: "MediConsult", arabic: "شركة ميدي كوسالت" },
        { english: "MedNet", arabic: "مدنت" },
        { english: "Medshield", arabic: "ميدشيلد" },
        { english: "MedSure", arabic: "مدشور" },
        { english: "Meridien Hotel", arabic: "فندق ميريديان" },
        { english: "MG", arabic: "شركة ام جي" },
        {
          english: "Middle Delta Electricity Production Company",
          arabic: "شركة وسط الدلتا لانتاج الكهرباء",
        },
        { english: "Ministry of Antiquities", arabic: "وزارة الاثار" },
        {
        ...
        { english: "Misr Healthcare", arabic: "مصر للرعاية الصحية" },
        {
          english: "Misr Service Management and Consultancy",
          arabic: "مصر لادارة الخدمات والاستشارات",
        },
        { english: "Misrelhayah", arabic: "المسرحية" },
        { english: "MOFTUC", arabic: "مفتك" },
        {
          english: "MOPCO - Misr Fertilizers Production Co.",
          arabic: "موبكو - شركة مصر لانتاج الاسمدة",
        },
        { english: "Mowafer Care", arabic: "موفر كير" },
        {
          english: "My Pharmacy for Medical Insurance",
          arabic: "صيدليتي للتأمين الطبي",
        },
        { english: "Mya Health Care", arabic: "ميا هيلث كير" },
        { english: "National Bank of Egypt", arabic: "البنك الأهلي المصري" },
        {
          english: "National Defense Council",
          arabic: "- General Secretariat\tمجلس الدفاع الوطني - الامانة العامة",
        },
        {
          english: "National Investment Bank (NIB)",
          arabic: "بنك الاستثمار القومي (NIB)",
        },
        { english: "National Misr Insurance", arabic: "الوطنية مصر للتأمين" },
        {
        ...
        { english: "Next care", arabic: "الرعاية التالية" },
        { english: "Nile Group", arabic: "مجموعة النيل" },
        { english: "Nile Petroleum Company", arabic: "شركة النيل للبترول" },
        { english: "Nilesat", arabic: "نايل سات" },
        {
        ...
        { english: "NSGB", arabic: "ان اس جي بي" },
        {
          english: "Nuclear Stations Organization",
          arabic: "هيئة المحطات النووية",
        },
        { english: "Nutshell Cuisines", arabic: "مطابخ الجوز" },
        {
        ...
        { english: "Okazion Care", arabic: "أوكازيون كير" },
        { english: "Omega Care", arabic: "أوميغا كير" },
        { english: "One Care", arabic: "رعاية واحدة" },
        {
          english: "OSOCO - Offshore Shukeir Oil Co.",
          arabic: "OSOCO - شركة نفط شقير البحرية",
        },
        { english: "Petro Amir Petroleum", arabic: "بترو امير للبترول" },
        { english: "Petro Gulf Co.", arabic: "شركة بترو جلف" },
        { english: "Petro Salam", arabic: "بترو سلام" },
        { english: "Petro Sila Company", arabic: "شركة بترو سيلا" },
        { english: "Petro trade", arabic: "بترو تريد" },
        { english: "Petrojet", arabic: "بتروجيت" },
        {
        ...
        { english: "Physiotherapy Syndicate", arabic: "نقابة العلاج الطبيعي" },
        { english: "Pico Petroleum", arabic: "بيكو بتروليوم" },
        { english: "Professional", arabic: "احترافي" },
        { english: "Qaroun Petroleum Company", arabic: "شركة قارون للبترول" },
        {
        ...
        { english: "Rotary", arabic: "الروتاري" },
        { english: "Royal Care", arabic: "رويال كير" },
        { english: "Safe Health Care", arabic: "الرعاية الصحية الآمنة" },
        {
          english: "Sedico Pharmaceuticals Company",
          arabic: "شركة سيديكو للأدوية",
        },
        { english: "Sehaty", arabic: "صحتي" },
        {
          english:
            "SIAC, Industrial Construction and Engineering Company\tSIAC",
          arabic: "، شركة الإنشاءات الصناعية والهندسة",
        },
        { english: "Sianco Egyptian Co.", arabic: "شركة صيانكو المصرية" },
        { english: "Sidco", arabic: "سيدكو" },
        { english: "Sierra Care", arabic: "سييرا كير" },
        { english: "Sinai Cement", arabic: "اسمنت سيناء" },
        {
          english: "Sinai Petroleum and Mining Services",
          arabic: "سيناء للخدمات البترولية والتعدين",
        },
        { english: "Sinai University", arabic: "جامعة سيناء" },
        { english: "SKPC", arabic: "اس كا بي سي" },
        { english: "Sky Time", arabic: "توقيت السماء" },
        { english: "Smart Care", arabic: "سمارت كير" },
        { english: "Smart School", arabic: "مدرسة سمارت" },
        {
          english:
        ...
        { english: "South Cairo Mills", arabic: "مطاحن جنوب القاهرة" },
        {
          english: "South Dabaah Petroleum Company",
          arabic: "شركة بترول جنوب الضبعة",
        },
        { english: "Special Family Care", arabic: "رعاية الأسرة الخاصة" },
        { english: "Suez Canal Authority", arabic: "هيئة قناة السويس" },
        {
        ...
        { english: "Suez Oil Company", arabic: "شركة السويس للبترول" },
        {
        ...
        {
          english:
            "Syndicate Committee of Hotel InterContinental Cairo Semiramis",
        ...
        { english: "Tanmia Petroleum Company", arabic: "شركة تنمية للبترول" },
        { english: "Teachers Syndicate", arabic: "نقابة المعلمين" },
        { english: "Telecom Egypt", arabic: "المصرية للاتصالات" },
        {
          english: "Tersana Club from Ahmed Orabi",
          arabic: "نادي الترسانة من احمد عرابي",
        },
        { english: "Tharwa Petroleum Co.", arabic: "شركة ثروة للبترول" },
        {
          english: "The Supreme Constitutional Court",
          arabic: "المحكمة الدستورية العليا",
        },
        { english: "The United Bank", arabic: "المصرف المتحد" },
        {
          english: "The Egyptian Ethylene and Derivatives Company",
          arabic: "الشركة المصرية للإيثيلين ومشتقاته",
        },
        { english: "Thomas Cook", arabic: "توماس كوك" },
        { english: "Time Health", arabic: "صحة الوقت" },
        {
          english: "Tour Guides Syndicate",
          arabic: "نقابة المرشدين السياحيين",
        },
        { english: "Town Gas", arabic: "غاز المدينة" },
        { english: "Toyota Company", arabic: "شركة تويوتا" },
        {
          english: "Trance Globe West Garib Company",
          arabic: "شركة ترانس جلوب ويست جريب",
        },
        { english: "Travel Choice", arabic: "اختيار السفر" },
        { english: "Tricare", arabic: "تريكير" },
        { english: "Tristar Cargo System", arabic: "تريستار لنظم الشحن" },
        {
          english: "Tristar Global Health (Paul Hadad)",
          arabic: "تريستار جلوبال هيلث (بول حداد)",
        },
        { english: "UBF", arabic: "يو بي اف" },
        { english: "UltraVision", arabic: "الترا فيجن" },
        { english: "Unilever", arabic: "يونيليفر" },
        { english: "United Company", arabic: "الشركة المتحدة" },
        {
          english: "United Gas Derivatives Company",
          arabic: "شركة مشتقات الغاز المتحدة",
        },
        { english: "Vacsera", arabic: "فاكسيرا" },
        { english: "VMEDIX for trading", arabic: "فيميديكس للتداول" },
        { english: "Wadi El Nile", arabic: "وادي النيل" },
        {
          english: "Watanya Integrated Solutions",
          arabic: "الوطنية للحلول المتكاملة",
        },
        { english: "WellCare", arabic: "رعاية جيدة" },
        {
          english: "WEPCO - Western Desert Operating Petroleum Company",
          arabic: "ويبكو - الصحراء الغربية التشغيل Petr",
        },
        { english: "West Bakr Petroleum", arabic: "غرب بكر للبترول" },
        {
          english: "West Giza Teachers Syndicate",
          arabic: "نقابة المعلمين غرب الجيزة",
        },
        { english: "Witch Care", arabic: "رعاية الساحرة" },
        { english: "X-FASTER Medical", arabic: "اكس- فاستر ميديكال" },
      ],
    };
  },
};
